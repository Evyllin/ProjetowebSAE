...
<script>
        function obterHoraSistema() {
            ...
            // Formate as horas e minutos como necessário
            if (horas < 10) {
                horas = '0' + horas;
            }
            if (minutos < 10) {
            ...
            // Defina a hora formatada no campo de entrada
...
<div class="p-5 mb-4 bg-light rounded-3">
	<div class="container py-5">
		<h1 class="display-5 fw-bold">Editar solicitação</h1>
		<h5>Preencha o formulário abaixo para
			realizar a alteração da solicitação no sistema.</h5>
	</div>
</div>
